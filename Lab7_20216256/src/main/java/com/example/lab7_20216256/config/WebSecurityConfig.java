package com.example.lab7_20216256.config;



import com.example.lab7_20216256.repository.UserRepository;
...
public class WebSecurityConfig {
    ...
    public WebSecurityConfig(DataSource dataSource, UserRepository usuarioRepository) {
